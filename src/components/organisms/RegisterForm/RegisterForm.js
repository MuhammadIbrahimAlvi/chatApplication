...
const RegisterForm = ({ classes }) => {
    ...
    const validationSchema = yup.object({
        fullName: yup.string('Enter your Full Name').required('Full Name is required').matches(/^[a-zA-Z]+$/, 'Enter a valid Name'),
    ...
    return (
        <div className={classes.RegisterForm}>
            ...
            <input type="file" accept="image/*" id ="image" onChange = {fileSelectedHandler}>
            </input>
